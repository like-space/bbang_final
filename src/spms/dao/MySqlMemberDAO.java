...
public class MySqlMemberDAO implements MemberDAO {
   ...
   public int insert(Member member) throws Exception {
      ...
      final String sqlInsert = "INSERT INTO MEMBERS(MNO, EMAIL, PWD, MNAME, PHONE, CRE_DATE, MOD_DATE)" +
   ...
   public int update(Member member) throws Exception {
      ...
      final String sqlUpdate = "UPDATE MEMBERS SET MNAME=?, PHONE=?, EMAIL=?, PWD=? WHERE EMAIL=?";
   ...
   @Override
   public Member chkDuplicate(String email) throws Exception {
      Member chkMember = null;
      Connection connection = null;
      PreparedStatement stmt = null;
      ResultSet rs = null;
      
      final String sqlChkDuplicate = "SELECT * FROM MEMBERS WHERE EMAIL=?";

      try {
         ApplicationContext ctx = ContextLoaderListener.getApplicationContext();
         
         DataSource ds2 = (DataSource)ctx.getBean("jndi.dataSource");
