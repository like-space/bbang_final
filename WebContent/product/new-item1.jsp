		...
		<div class="container">
			<div class="chef-item" style="border-style: none;">
				...
				<table>
					...
					<c:if test="${detail_path ne null and detail_path ne '' }">
										<img src="<%=request.getContextPath() %>/${detail_path}">
					...
					<td class="ssss">
						...
						<button class="btn btn.btn-primary" id="select">수량 :</button> <input
						type="text" name="pop_out" id="pop_out" value="0"
